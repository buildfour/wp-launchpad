...
--
-- Class AccessSession as table access_session
--
...
--
-- Class ActivityLog as table activity_logs
--
...
--
-- Class ProjectState as table project_state
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('wp_launchpad', '20260125161530585', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260125161530585', "timestamp" = now();
